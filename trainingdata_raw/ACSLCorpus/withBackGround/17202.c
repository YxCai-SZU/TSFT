...
/*@ predicate is_special(integer n) =
      ...
      n == 90 || n == 91 || n == 92 || n == 93 || n == 94 || n == 95 || n == 96 || n == 97 || n == 98;
*/

/*@ lemma special_implies_range: \forall integer n; is_special(n) ==> is_in_range(n); */

/*@
  requires is_in_range(n);
  ensures \result == true <==> is_special(n);
  assigns \nothing;
*/
